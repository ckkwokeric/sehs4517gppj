    ...
    <div class="container3">
        ...
        <form action="">
            <div class="question-details">
                ...
                <span class="question-title">1. In the past month, how many times have you felt unexplainably
                    exhausted?</span>
                <div class="category">
                    <label for="dot-1">
            ...
            <div class="question-details">
                ...
                <span class="message error-message">*This question had not answered yet.</span>
                <span class="question-title">5. During the past 1 month, how often did you feel restless or
                    fidgety?</span>
                <div class="category">
                    <label for="dot5-1">
                        <span class="dot one"></span>
            ...
            <div class="question-details">
                ...
                <span class="message error-message">*This question had not answered yet.</span>
                <span class="question-title">6. During the past 1 month, how often did you feel so restless that you
                    could not sit still?</span>
                <div class="category">
                    <label for="dot6-1">
                        <span class="dot one"></span>
                        <span class="question"> All of the time</span>
            ...
            <div class="question-details">
                ...
                <span class="message error-message">*This question had not answered yet.</span>
                <span class="question-title">8. During the past 1 month, how often did you feel so depressed that
                    nothing could cheer you up?</span>
                <div class="category">
                    <label for="dot8-1">
                        <span class="dot one"></span>
                        <span class="question"> All of the time</span>
